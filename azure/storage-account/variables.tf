...
variable "primary_msi_id" {
  type        = string
  description = "The ID of the primary managed service identity (MSI) associated with the storage account. If this is set, the storage account will be created with a user-assigned identity. If this is not set, the storage account will be created with a system-assigned identity."
  default     = null
}
...
variable "storage_shares" {
  ...
  description = "Map of storage shares to create"
  default     = {}
}