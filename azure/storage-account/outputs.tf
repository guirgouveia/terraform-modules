...
output "storage_container_names" {
  description = "Map of storage containers and their attributes."
  value       = zipmap(keys(azurerm_storage_container.main), values(azurerm_storage_container.main)[*].name)
}

output "storage_container_names_2" {
  description = "Map of storage containers and their attributes."
